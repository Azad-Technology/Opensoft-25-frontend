...
const EmployeeReportPDF = ({ data }) => {
  ...
  const getSentimentStyle = (sentiment) => {
    ...
    if (sentimentLower.includes("positive") || sentimentLower.includes("good"))
      return styles.positive;
    if (sentimentLower.includes("negative") || sentimentLower.includes("poor"))
  ...
  const monthlyLeaveData = Object.entries(leaveAnalysis.monthly_breakdown || {})
    .map(([month, values]) => ({
      month,
      ...
      <Page size="A4" style={styles.page}>
          ...
          <View style={styles.row}>
            <View style={styles.col}>
              ...
              <Text style={styles.text}>
                Employee ID:{" "}
                <Text style={styles.bold}>
                  {formatValue(employeeInfo.employee_id)}
                </Text>
              </Text>
            </View>
            <View style={styles.col}>
              <Text style={styles.text}>
                Email:{" "}
                <Text style={styles.bold}>
                  {formatValue(employeeInfo.email)}
                </Text>
              </Text>
              <Text style={styles.text}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.row}>
            <View style={styles.col}>
              <Text style={styles.text}>
                Current Vibe Score:{" "}
                <Text style={styles.bold}>
                  {formatValue(currentState.vibe_score)}/5
                </Text>
              </Text>
              <Text style={styles.text}>
                Last Check-in:{" "}
                <Text style={styles.bold}>
                  {formatDate(currentState.last_check_in)}
                </Text>
              </Text>
            </View>
            <View style={styles.col}>
              <Text style={styles.text}>
                Risk Assessment:{" "}
                <Text style={styles.bold}>
                  {formatValue(currentState.risk_assessment)}/5
                </Text>
              </Text>
              <Text style={styles.text}>
                Current Vibe:{" "}
                <Text style={styles.bold}>
                  {formatValue(vibeTrend[0]?.vibe)}
                </Text>
              </Text>
            </View>
          </View>
          ...
          <View
            style={[
              styles.riskBox,
              getRiskLevelStyle(currentState.risk_assessment),
            ]}
          >
            <Text style={styles.text}>
          ...
          <Text style={styles.text}>
            Intent Analysis Updated At:{" "}
            <Text style={styles.bold}>
              {formatDate(intentAnalysis.updated_at)}
            </Text>
          </Text>
        </View>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.text}>
            Composite Score:{" "}
            <Text style={styles.bold}>
              {formatValue(chatAnalysis.wellbeing_analysis?.composite_score)}
              /100
            </Text>
          </Text>
          ...
          <View style={{ marginTop: 10 }}>
            {Object.entries(
              chatAnalysis.wellbeing_analysis?.component_breakdown || {},
            ).map(([key, value], index) => (
              <View key={index} style={styles.tagBox}>
                <View style={styles.row}>
                  ...
                  <View style={styles.col}>
                    <Text style={styles.text}>
                      Score: {formatValue(value.score)}/30
                    </Text>
                  </View>
                </View>
        ...
        <View style={styles.section} break>
          ...
          <View style={styles.chatAnalysisBox}>
            <Text style={[styles.text, styles.bold, { fontSize: 11 }]}>
            ...
            <View style={styles.row}>
                    ...
                    style={[
                      styles.riskIndicator,
                      {
                        backgroundColor: getRiskLevelColor(
                          chatAnalysis.risk_assessment?.risk_level,
                        ),
                      },
                    ]}
                  />
                  <Text style={styles.metricValue}>
                    {formatValue(chatAnalysis.risk_assessment?.risk_level)}/5
                  </Text>
                </View>
              </View>
              ...
              <View style={styles.metricBox}>
                ...
                <Text style={styles.metricValue}>
                  {formatValue(chatAnalysis.engagement_level || "Medium")}
                </Text>
              </View>
              ...
              <View style={styles.metricBox}>
                ...
                <Text style={styles.metricValue}>
                  {formatValue(
                    chatAnalysis.communication_style || "Collaborative",
                  )}
                </Text>
              </View>
            </View>
            ...
            <View style={styles.insightBox}>
              ...
              <Text style={styles.text}>
                {formatValue(chatAnalysis.summary)}
              </Text>
            </View>
            ...
            <View style={styles.row}>
              <View style={styles.col}>
                <Text style={[styles.text, { marginTop: 8 }]}>
                  Recommended Mentor:{" "}
                  <Text style={styles.bold}>
                    {formatValue(chatAnalysis.recommended_mentor)}
                  </Text>
                </Text>
              </View>
              <View style={styles.col}>
                <Text style={[styles.text, { marginTop: 8 }]}>
                  Last Analyzed:{" "}
                  <Text style={styles.bold}>
                    {formatDate(chatAnalysis.last_analyzed || new Date())}
                  </Text>
                </Text>
              </View>
            </View>
          ...
          {(intentAnalysis.tags || []).map((tag, index) => (
            <View key={index} style={styles.tagBox}>
              <View style={styles.row}>
                <View style={styles.col}>
                  <Text style={[styles.text, styles.bold]}>
                    {formatValue(tag.tag).replace(/_/g, " ")}
                  </Text>
                </View>
                <View style={styles.col}>
                  <Text style={styles.text}>
                    Priority :{" "}
                    {(formatValue(tag.weight) * 100).toFixed(0) > 60
                      ? "High"
                      : (formatValue(tag.weight) * 100).toFixed(0) > 40
                        ? "Medium"
                        : "Low"}
                  </Text>
                </View>
              ...
              <Text style={styles.text}>
                Description: {formatValue(tag.description)}
              </Text>
              <Text style={styles.text}>
                Completed:{" "}
                <Text style={styles.bold}>
              ...
              {tag.summary && (
                <Text style={[styles.text, { fontStyle: "italic" }]}>
                  Summary: {formatValue(tag.summary)}
                </Text>
              )}
            </View>
          ))}
        ...
        <View style={styles.section}>
          ...
          <View style={styles.row}>
            <View style={styles.col}>
              ...
              <Text style={styles.text}>
                ...
                <Text style={styles.bold}>
                  {formatValue(
                    communicationActivity.weekly_averages?.teams_messages,
                  )}
                </Text>
              </Text>
              <Text style={styles.text}>
                Emails:{" "}
                <Text style={styles.bold}>
                  {formatValue(communicationActivity.weekly_averages?.emails)}
                </Text>
              </Text>
              <Text style={styles.text}>
                Meetings:{" "}
                <Text style={styles.bold}>
                  {formatValue(communicationActivity.weekly_averages?.meetings)}
                </Text>
              </Text>
              <Text style={styles.text}>
                Work Hours:{" "}
                <Text style={styles.bold}>
                  {formatValue(
                    communicationActivity.weekly_averages?.work_hours,
                  )}
                </Text>
              </Text>
            </View>
            <View style={styles.col}>
              ...
              <Text style={styles.text}>
                ...
                <Text style={styles.bold}>
                  {formatValue(
                    communicationActivity.communication_scores?.messages_score,
                  )}
                  %
                </Text>
              </Text>
              <Text style={styles.text}>
                ...
                <Text style={styles.bold}>
                  {formatValue(
                    communicationActivity.communication_scores?.emails_score,
                  )}
                  %
                </Text>
              </Text>
              <Text style={styles.text}>
                ...
                <Text style={styles.bold}>
                  {formatValue(
                    communicationActivity.communication_scores?.meetings_score,
                  )}
                  %
                </Text>
              </Text>
          ...
          {(communicationActivity.activity_level || [])
            .slice(0, 5)
            .map((activity, index) => (
              <View key={index} style={styles.tableRow}>
                ...
                <Text style={styles.tableCell}>
                  {formatValue(activity.teamsMessages)} msgs
                </Text>
                <Text style={styles.tableCell}>
                  {formatValue(activity.emails)} emails
                </Text>
                <Text style={styles.tableCell}>
                  {formatValue(activity.meetings)} meetings
                </Text>
                <Text style={styles.tableCell}>
                  {formatValue(activity.work_hours)} hrs
                </Text>
              </View>
            ))}
        </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.row}>
            <View style={styles.col}>
              ...
              {Object.entries(leaveAnalysis.total_leaves || {}).map(
                ([key, value], index) => (
                  <Text key={index} style={styles.text}>
                    {key.charAt(0).toUpperCase() + key.slice(1)}:{" "}
                    <Text style={styles.bold}>{formatValue(value)}</Text>
                  </Text>
                ),
              )}
            </View>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.text}>
            Total Points:{" "}
            <Text style={styles.bold}>{formatValue(awards.total_points)}</Text>
          </Text>
            ...
            <View style={styles.col}>
              ...
              {(awards.recent_awards || []).length > 0 ? (
                (awards.recent_awards || []).slice(0, 3).map((award, index) => (
                  ...
                  >
                    <Text style={[styles.text, styles.bold]}>
                      {formatValue(award.type)}
                    </Text>
                    <Text style={styles.text}>
                      Points: {formatValue(award.points)}
                    </Text>
          ...
          <View style={styles.row}>
            <View style={styles.col}>
              <Text style={styles.text}>
                Current Rating:{" "}
                <Text style={styles.bold}>
                  {formatValue(performance.current?.rating)}/5
                </Text>
              </Text>
              <Text style={styles.text}>
                Feedback:{" "}
                <Text style={styles.bold}>
                  {formatValue(performance.current?.feedback)}
                </Text>
              </Text>
              <Text style={styles.text}>
                Period:{" "}
                <Text style={styles.bold}>
                  {formatValue(performance.current?.period)}
                </Text>
              </Text>
            </View>
            <View style={styles.col}>
              ...
              <View style={styles.chart}>
                {(performance.trend?.ratings || []).map((rating, index) => (
                  <View key={index} style={{ alignItems: "center" }}>
                    ...
                    />
                    <Text style={styles.chartLabel}>
                      {formatValue(performance.trend?.periods?.[index])}
                    </Text>
                  </View>
                ))}
              </View>
            ...
            <View style={styles.tableContainer}>
              ...
              {(performance.history || []).map((item, index) => (
                <View key={index} style={styles.tableRow}>
                  ...
                  <Text style={styles.tableCell}>
                    {formatValue(item.rating)}/5
                  </Text>
                  <Text style={styles.tableCell}>
                    {formatValue(item.feedback)}
                  </Text>
                </View>
              ))}
            </View>
          ...
          <View style={styles.row}>
            <View style={styles.col}>
              <Text style={styles.text}>
                Feedback:{" "}
                <Text style={styles.bold}>
                  {formatValue(onboarding.feedback)}
                </Text>
              </Text>
            </View>
            <View style={styles.col}>
              <Text style={styles.text}>
                Mentor Assigned:{" "}
                <Text style={styles.bold}>
                  {onboarding.mentor_assigned === true
                    ? "Yes"
                    : onboarding.mentor_assigned === false
                      ? "No"
                      : "?"}
                </Text>
              </Text>
              <Text style={styles.text}>
                Training Completed:{" "}
                <Text style={styles.bold}>
                  {onboarding.training_completed === true
                    ? "Yes"
                    : onboarding.training_completed === false
                      ? "No"
                      : "?"}
                </Text>
              </Text>
...
const EmployeeReportGenerator = ({ employeeData }) => {
  ...
  return (
    <div className="pdf-report-container">
      ...
      <div className="flex justify-between items-center mb-6">
        <div className="flex-1">
          ...
          <p className="text-sm text-gray-500">
            For {employeeData.employee_info?.name || "Employee"}
          </p>
        </div>
        <PDFDownloadLink
      ...
      {/* PDF Viewer */}
      <div
        className="pdf-viewer-container w-full overflow-hidden rounded-lg border border-gray-200 shadow-lg"
        style={{ height: "800px" }}
      >
