...
const PerformanceReviewCard = ({
  review = { Review_Period: "H1 2023", Performance_Rating: 4, Manager_Feedback: "Needs Improvement" },
}) => {
  ...
  return (
    <motion.div whileHover={{ y: -4 }} className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-xl p-6 mb-2 shadow-lg border border-gray-100 dark:border-gray-700">
      <div className="flex justify-between items-start mb-4">
        <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Performance Review</h3>
        <span
      ...
      <div className="space-y-4">
        ...
        <div>
          <div className="flex justify-between mb-1">
            ...
            <span className="text-sm text-gray-700 dark:text-gray-300">{review.Performance_Rating}/5</span>
          </div>
        ...
        <div className="mt-4">
          <p className="text-gray-500 dark:text-gray-400 text-sm mb-1">Manager Feedback</p>
          <div className="bg-gray-100/80 dark:bg-gray-700/80 rounded-lg p-3">
            <p className="text-gray-700 dark:text-gray-300">{review.Manager_Feedback}</p>
          </div>
        </div>
      </div>
    </motion.div>
