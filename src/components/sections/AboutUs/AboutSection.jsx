      ...
      <div className="container">
        <div className="about-content">
          <div className="about-text animate-fade-right">
            ...
            <p className="about-paragraph">
              By combining cutting-edge technology with evidence-based wellness practices, we've created a 
              comprehensive solution that benefits both employees and organizations. Our approach is 
              rooted in privacy, actionable insights, and continuous improvement.
            </p>
            ...
            <div className="vision-card-container">
              ...
              <div className="vision-card glass-card">
                ...
                <p className="vision-paragraph">
                  We envision a future where workplace wellness is integral to organizational culture, 
                  where employees feel valued, supported, and empowered to bring their best selves to work every day.
                </p>
