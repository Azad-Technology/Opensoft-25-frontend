...
useEffect(() => {
  ...
  return (
      ...
      <div className="neo-glass rounded-xl p-6 mb-8 animate-fade-in m-10">
        <div className="mb-8 animate-fade-in">
          <h1 className="page-header mb-2">Severe Employee Reports</h1>
          <p className="text-muted-foreground">
            View and analyze detailed reports for all severe employees
          </p>
        </div>
              ...
              <tbody>
                {loading ? (
                  ...
                  currentPosts.map((employee) => (
                    <tr key={employee.employee_id} className="border-b border-border hover:cursor-pointer"
                    onClick={() => navigate(`/admin/reports/${employee.employee_id}`)}>
                      <td className="p-4">
