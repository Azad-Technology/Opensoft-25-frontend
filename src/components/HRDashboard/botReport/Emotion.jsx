...
const Emotion = ({ result }) => {
  // Extract wellbeing analysis data safely
  const dataToAnalyze = result?.chat_analysis?.wellbeing_analysis?.component_breakdown || {};
  
  // Function to extract the main word before an underscore
  ...
  // Process wellbeing data for radar chart
  const wellbeingData = [];
