...
const CardFooter = ({ children, className }) => {
  return <div className={`flex items-center px-6 py-4 ${className || ""}`}>{children}</div>;
};
  ...
  return (
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-emerald-100">
      <div className="container mx-auto px-4 py-8">
        ...
        >
          <div>
            <h1 className="flex items-center text-3xl font-bold text-green-700">
              <span className="inline-block">Employee Onboarding</span>
            </h1>
            <p className="text-muted-foreground">Add new team members to your organization</p>
          </div>
        </motion.div>
        ...
        >
          ...
          <Card className="relative overflow-hidden border-green-200 bg-white/80 backdrop-blur-sm transition-all duration-300 hover:shadow-xl">
            <div className="absolute inset-0 bg-gradient-to-br from-green-50/50 to-transparent" />

            <CardHeader className="relative border-b border-green-100 bg-gradient-to-r from-green-100 to-emerald-100">
              <CardTitle className="flex items-center gap-2 text-green-700">
                <UserPlus className="h-5 w-5" />
                New Team Member Registration
              </CardTitle>
              <CardDescription>Enter the details to add a new member to your organization</CardDescription>
            </CardHeader>

            <form onSubmit={handleSubmit}>
              <CardContent className="relative grid gap-6 pt-6">
                <motion.div
                  className="mb-4 rounded-lg border border-green-100 bg-green-50 p-4"
                  initial={{ opacity: 0, y: -10 }}
                  animate={{ opacity: 1, y: 0 }}
                  transition={{ delay: 0.2 }}
                >
                  <Label className="mb-3 block font-medium text-green-800">
                    Select Member Type
                  </Label>
                ...
                >
                  ...
                  <div className="flex gap-2">
                    ...
                    <Button
                      ...
                      className="flex-shrink-0 border-green-200 bg-green-50 text-green-700 transition-all duration-300 hover:bg-green-100 hover:text-green-800"
                    >
                      Auto Generate
                    </Button>
                  </div>
              ...
              <CardFooter className="relative border-t border-green-100 bg-gradient-to-r from-green-100 to-emerald-100">
                <Button
                  variant="outline"
                  type="button"
                  className="border-green-200 bg-white/80 transition-all duration-300 hover:bg-white"
                >
                  Cancel
                </Button>
                <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} className="ml-auto">
                  <Button
                    type="submit"
                    className="relative overflow-hidden bg-gradient-to-r from-green-600 to-emerald-600 text-white transition-all duration-300 hover:from-green-700 hover:to-emerald-700"
                  >
