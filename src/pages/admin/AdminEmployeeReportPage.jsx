...
const AdminEmployeeReportPage = () => {
    ...
    const sampleData = {
        leave: {
            score: 4.2,
            comment: "Excellent leave management with proper planning and communication",
            leaveDensity: 1.5,
            reasons: [
        ...
        experience: {
            onboardingFeedback: "Demonstrated exceptional adaptability and quick learning during the onboarding process",
            mentorAssigned: true,
        ...
        performance: {
            ...
            workingHours: 8.2,
            awards: 2,
            managerFeedback: "Sarah consistently delivers high-quality work and demonstrates strong initiative in team projects. Her collaborative approach and technical expertise have been valuable assets to the team."
        },
        emotion: {
            state: "Happy",
            inferences: [
